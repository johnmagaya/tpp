...
$query=mysqli_query($con,"SELECT *  FROM students WHERE StudentID='$sid'");
                                                    ...
                                                    $fname=$num['Firstname']." ".$num['Lastname'];
...
$num=mysqli_fetch_array($query);
   ...
   $pid=$num['npid'];
   $cdate=date('Y-m-d');
 $sql3="INSERT INTO comments (Tid, Pid, Tcomment, Comby, Cdate) VALUES ('$tid', '$pid', '$message', '$fname', '$cdate')";
                                    ...
                                    <div class="module-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                 <?php
                                                $sid = $_SESSION['SID'];
                                                $cnt2=mysqli_query($con,"SELECT * FROM taskreport,tasks,project,team WHERE  taskreport.tid=tasks.tid and tasks.Pid=project.Pid and project.Pname=team.Pname and team.Member='$sid'");
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                       <form action="task_report.php" method="post"><textarea name="msg" id="msg" cols="12" rows="6" style="width: 100%;" required></textarea></div>
