...
if ( isset($_GET['success']) && $_GET['success'] == 1 )
{
    ...
    echo ' alert("You cannot create a task for this project your not a project leader")';  //not showing an alert box.
    echo '</script>';
}
?>
    <!DOCTYPE html>
                                ...
                                <div class="content">
                                    ...
                                    <div class="module">
                                        ...
                                        <div class="module-body">
                                            <a href=""><button class="btn btn-primary pull-right " data-toggle="modal" data-target="#projectcreate"><i class="icon-plus-sign-alt"></i> Create Project</button></a>
                                            <table class="table">
                                                <thead style="background-color: #2352b1;color:black;">
                                                    <tr>
                                             ...
                                             if(isset($_POST['search'])) {
                                                $pname=$_POST['pname'];
                                                $sid = $_SESSION['SID'];
                                                $cnt2=mysqli_query($con,"SELECT * FROM project,team,students WHERE project.Pname LIKE '%{$pname}%' and Member='$sid' and team.Pname=project.Pname and Member=StudentID and team.Tstatus='Active'");
                                                ...
                                                $sid = $_SESSION['SID'];
                                                $cnt2=mysqli_query($con,"SELECT * FROM project,team,students WHERE  Member='$sid' and team.Pname=project.Pname and Member=StudentID and team.Tstatus='Active'");
