                                    ...
                                    <table class="table table-message">
                                        <tbody>
                                            <tr class="heading">
                                                ...
                                                <td class="cell-author hidden-phone hidden-tablet">Sent By </td>
                                                ...
                                                <td class="cell-author hidden-phone hidden-tablet">Respond to Invite</td>
                                            
                                            </tr>
                                            <?php
                                                $sid = $_SESSION['SID'];
                                                $cnt=mysqli_query($con,"SELECT * FROM invite,students WHERE  Receiver='$sid' and Istatus='Pending' and Sender=StudentID");
                                            ...
                                            <tr class="unread">
                                                ...
                                                <td class="cell-author hidden-phone hidden-tablet"><a href="accept_invite.php?iid=<?php echo $cnt1['ID'];?>" class="btn btn-primary">Accept</a>-<a href="reject_invite.php?iid=<?php echo $cnt1['ID'];?>" class="btn btn-danger">Reject</a></td>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="contorls">
                                                            <select class="span4" name="pname" id="pname" required>
                                                                ...
                                                                <?php
                                                $sid = $_SESSION['SID'];
                                                $cnt2=mysqli_query($con,"SELECT Distinct project.Pname as Pname FROM project,team,students WHERE  Member='$sid' and team.Pname=project.Pname and Member=StudentID and MemberType='Leader' or CreatedBy='$sid'");
