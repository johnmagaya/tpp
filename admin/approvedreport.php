                                ...
                                <div class="module">
                                    ...
                                    <div class="module-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                 <?php
                                                $cnt2=mysqli_query($con,"SELECT * FROM taskreport,tasks,project WHERE  taskreport.tid=tasks.tid and tasks.Pid=project.Pid and taskreport.Rstatus='Approved'");
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="approvedreport.php" method="post"><textarea name="msg" id="msg" cols="12" rows="6" style="width: 100%;" required></textarea></div>
...
2014 Edmin - EGrappler.com </b>All rights reserved. --></div>
            ...
            <script src="https://kit.fontawesome.com/8aeb68ef3d.js" crossorigin="anonymous"></script>
    </body>