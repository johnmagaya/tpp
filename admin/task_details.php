                                    ...
                                    <div class="module-body">
                                        ...
                                        <div class="control-group pull-right">
                                            ...
                                            <div class="control-group pull-right">
                                                ...
                                                <div class="contorls"><strong><?php echo $project2['Attach'];?></strong></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="module-body">
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    ...
                                                    <br>
                                                    <?php } ?>
                                                    <a href=""><button class="btn btn-info"><i class="icon-bar-chart"></i>View Schedule</button></a> <a href="task_report.php"><button class="btn btn-secondary"><i class="icon-folder-close-alt"></i>View Reports</button></a>                                                    <a href=""><button class="btn btn-danger pull-right " data-toggle="modal" data-target="#taskupload"><i class="icon-tasks"></i>Upload Task Report</button></a></div>
                                            </div>
                                        </div>
                                        <!-- Modal -->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="addreport.php" method="post" enctype="multipart/form-data">
                                                            <label class="upload">Upload File<input name='file' type="file" required> </label>
